...
function updateLineChart(selectedCountry, selectedVar) {
  ...
  d3.csv(
    ...
    lineYlabel = lineYlabel.charAt(0).toUpperCase() + lineYlabel.slice(1);
    ...
    // Add country label
    svg.select(".countryLabel").transition(1000).text(selectedCountry);
    ...
    function mousemove(event) {
      ...
      focusText
        .text(`Cases: ${formatter(selectedData.value)}`)
...
export default updateLineChart;
