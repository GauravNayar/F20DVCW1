...
function scatterPlot() {
  ...
  d3.csv(
    ...
    function (d) {
      return {
        date: d.date,
        value1: d.total_cases_per_million,
    ...
    xAxis.transition().duration(2000).call(d3.axisBottom(x).ticks(9));
    ...
    svg
      ...
      .text("Total cases per million (log scale)");
    ...
    const mousemove = (event, d) => {
      ...
      Tooltip.html(
        d.country + "<br>" + "gdp per capita: " + formatter(d.value2) // Tooltip content
      )
    ...
    function onScatHighlight(d) {
      ...
      labelsGroup
        ...
        .text("GDP:  " + formatter(scatItem.value2));
    }
